...
Its functional features facilitate its use for writing concurrent programs that make use of several cores or processors.
Scala compiles to Java bytecode running on the JVM. It has excellent interoperability with Java; 
its Java libraries can be used by Scala seamlessly.
